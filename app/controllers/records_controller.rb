class RecordsController < ApplicationController
    ...
    def index 
        ...
        @batting_rate_info = batters_info.sort_by { |_, rate, _, _ | rate }.reverse[0..2]
        @batting_number_info = batters_info.sort_by { |_, _, number, _| number }.reverse[0..2]
        @ops_info = batters_info.sort_by { |_, _, _, ops| ops }.reverse[0..2]
    end
end
